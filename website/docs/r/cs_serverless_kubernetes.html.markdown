...
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_cs_serverless_kubernetes"
sidebar_current: "docs-apsarastack-resource-cs-serverless-kubernetes"
description: |-
  Provides a ApsaraStack resource to manage container serverless kubernetes cluster.
---

# apsarastack\_cs\_serverless_kubernetes
...
resource "apsarastack_cs_serverless_kubernetes" "serverless" {
...
* `name` - (Optional) The kubernetes cluster's name. It is the only in one ApsaraStack account.
...
```
$ terraform import apsarastack_cs_serverless_kubernetes.main ce4273f9156874b46bb
```
