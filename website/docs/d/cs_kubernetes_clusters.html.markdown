...
description: |-
  Provides a list of Container Service Kubernetes Clusters to be used by the apsarastack_cs_kubernetes_clusters resource.
---
...
output "output" {
  value = "${data.apsarastack_cs_kubernetes_clusters.k8s_clusters.clusters}"
}
```
