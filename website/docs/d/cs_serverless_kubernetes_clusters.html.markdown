...
layout: "apsarastack"
page_title: "Apsarastack: apsarastack_cs_serverless_kubernetes_clusters"
sidebar_current: "docs-apsarastack-datasource-cs-serverless-kubernetes-clusters"
description: |-
  Provides a list of Container Service Serverless Kubernetes Clusters to be used by the apsarastack_cs_serverless_kubernetes_clusters resource.
---

# apsarastack\_cs\_serverless\_kubernetes\_clusters

This data source provides a list Container Service Serverless Kubernetes Clusters on ApsaraStack Cloud.
...
data "apsarastack_cs_serverless_kubernetes_clusters" "k8s_clusters" {
  name_regex  = "my-first-k8s"
  output_file = "my-first-k8s-json"
}

output "output" {
  value = "${data.apsarastack_cs_serverless_kubernetes_clusters.k8s_clusters.clusters}"
}
```
