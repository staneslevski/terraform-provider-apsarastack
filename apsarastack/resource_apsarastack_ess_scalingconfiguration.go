	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"instance_type": {
				...
				//ConflictsWith: []string{"instance_types"},//ConflictsWith cannot be used with required parameter
			},
			"instance_types": {
				...
				Optional: true,
				//ConflictsWith: []string{"instance_type"},//cannot be used as instance_type has been set as required in Apsarastack
			...
			"security_group_id": {
				Type:     schema.TypeString,
				Required: true,
				//	ConflictsWith: []string{"security_group_ids"},//has been removed for Apsarastack
			},
			//"security_group_ids": {//security_group_ids has been removed for Apsarastack
			//	Type: schema.TypeList,
			//	Elem: &schema.Schema{
			//		Type: schema.TypeString,
			//	},
			...
			//"internet_charge_type": {//internet_charge_type has been removed for Apsarastack
			//	Type:         schema.TypeString,
			//	Optional:     true,
			...
			//"internet_max_bandwidth_out": {//internet_max_bandwidth_out has been removed for Apsarastack
			//	Type:         schema.TypeInt,
			//	Optional:     true,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"device": {
							Type:     schema.TypeString,
							Optional: true,
							//Deprecated has been removed for Apsarastack
...
func modifyEssScalingConfiguration(d *schema.ResourceData, meta interface{}) error {
	...
	//hasChangeSecurityGroupIds := d.HasChange("security_group_ids")//has been removed for Apsarastack
...
func resourceApsaraStackEssScalingConfigurationRead(d *schema.ResourceData, meta interface{}) error {
	...
	//d.Set("internet_charge_type", object.InternetChargeType)//has been removed for Apsarastack
	d.Set("internet_max_bandwidth_in", object.InternetMaxBandwidthIn)
	//d.Set("internet_max_bandwidth_out", object.InternetMaxBandwidthOut)//has been removed for Apsarastack
	...
	//d.Set("password_inherit", object.PasswordInherit)//has been removed for Apsarastack
...
func buildApsaraStackEssScalingConfigurationArgs(d *schema.ResourceData, meta interface{}) (*ess.CreateScalingConfigurationRequest, error) {
	...
	//request.PasswordInherit = requests.NewBoolean(d.Get("password_inherit").(bool))//has been removed for Apsarastack
	...
	//if v := d.Get("internet_charge_type").(string); v != "" {//has been removed for Apsarastack
	...
	//has been removed from Apsarastack
