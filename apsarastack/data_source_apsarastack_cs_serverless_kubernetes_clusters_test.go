...
func TestAccApsaraStackCSServerlessKubernetesClustersDataSource(t *testing.T) {
	rand := acctest.RandIntRange(1000000, 9999999)
	resourceId := "data.apsarastack_cs_serverless_kubernetes_clusters.default"
	...
	idsConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"enable_details": "true",
			"ids":            []string{"${apsarastack_cs_serverless_kubernetes.default.id}"},
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"enable_details": "true",
			"ids":            []string{"${apsarastack_cs_serverless_kubernetes.default.id}-fake"},
		}),
	}
	...
	nameRegexConf := dataSourceTestAccConfig{
		existConfig: testAccConfig(map[string]interface{}{
			"enable_details": "true",
			"name_regex":     "${apsarastack_cs_serverless_kubernetes.default.name}",
		}),
		fakeConfig: testAccConfig(map[string]interface{}{
			"enable_details": "true",
			"name_regex":     "${apsarastack_cs_serverless_kubernetes.default.name}-fake",
		}),
	}
...
resource "apsarastack_cs_serverless_kubernetes" "default" {
