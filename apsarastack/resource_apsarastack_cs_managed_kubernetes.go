...
func resourceApsaraStackCSManagedKubernetes() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackCSManagedKubernetesCreate,
...
func resourceApsaraStackCSManagedKubernetesCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err := invoker.Run(func() error {
		...
		return WrapErrorf(err, DefaultErrorMsg, "apsarastack_cs_managed_kubernetes", "CreateKubernetesCluster", response)
	}
	if debugOn() {
