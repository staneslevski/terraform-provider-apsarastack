...
// resourceApsaraStackCSKubernetesAutoscaler defines the schema of resource
func resourceApsaraStackCSKubernetesAutoscaler() *schema.Resource {
	return &schema.Resource{
		Create: resourceApsaraStackCSKubernetesAutoscalerCreate,
		Read:   resourceApsaraStackCSKubernetesAutoscalerRead,
		Update: resourceApsaraStackCSKubernetesAutoscalerUpdate,
		Delete: resourceApsaraStackCSKubernetesAutoscalerDelete,
...
// resourceApsaraStackCSKubernetesAutoscalerCreate define how to create autoscaler
func resourceApsaraStackCSKubernetesAutoscalerCreate(d *schema.ResourceData, meta interface{}) error {
	clusterId := d.Get("cluster_id").(string)
	// set unique id of tf state
	d.SetId(fmt.Sprintf("%s:%s", clusterId, clusterAutoscaler))
	return resourceApsaraStackCSKubernetesAutoscalerUpdate(d, meta)
}

// resourceApsaraStackCSKubernetesAutoscalerRead no need to implement
func resourceApsaraStackCSKubernetesAutoscalerRead(d *schema.ResourceData, meta interface{}) error {
	return nil
}

// resourceApsaraStackCSKubernetesAutoscalerUpdate define how to update autoscaler configuration
func resourceApsaraStackCSKubernetesAutoscalerUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceApsaraStackCSKubernetesAutoscalerDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*connectivity.ApsaraStackClient)
	regionId := client.RegionId
...
func UpdateScalingGroupConfiguration(client *connectivity.ApsaraStackClient, groupId, userData string, labels string, taints string) (err error) {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, groupId, describeScalingConfigurationsRequest.GetActionName(), ApsaraStackSdkGoERROR)
	}
	...
	if len(configurations.ScalingConfigurations.ScalingConfiguration) == 0 {
		...
		if err != nil {
			return WrapErrorf(err, DefaultErrorMsg, groupId, modifyScalingConfigurationRequest.GetActionName(), ApsaraStackSdkGoERROR)
		}
...
func GetScalingGroupSizeRange(client *connectivity.ApsaraStackClient, groupId string) (min, max int, err error) {
	...
	if err != nil {
		return 0, 0, WrapErrorf(err, DefaultErrorMsg, groupId, describeScalingGroupRequest.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func DownloadUserKubeConf(client *connectivity.ApsaraStackClient, clusterId string) (string, error) {
	...
	if err != nil {
		return "", WrapErrorf(err, DefaultErrorMsg, clusterId, describeClusterUserKubeconfigRequest.GetActionName(), ApsaraStackSdkGoERROR)
	}
...
func applyDefaultArgs(args []string) []string {
	...
	args = append(args, "--cloud-provider=apsarastack")
