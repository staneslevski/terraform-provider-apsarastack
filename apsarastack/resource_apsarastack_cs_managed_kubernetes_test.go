...
func TestAccApsaraStackCSManagedKubernetes_basic(t *testing.T) {
	var v *cs.KubernetesClusterDetail

	resourceId := "apsarastack_cs_managed_kubernetes.default"
...
data "apsarastack_instance_types" "default2" {
...
func TestAccApsaraStackCSManagedKubernetes_upgrade(t *testing.T) {
	var v *cs.KubernetesClusterDetail
