...
func dataSourceApsaraStackCSManagerKubernetesClusters() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceApsaraStackCSManagerKubernetesClustersRead,
...
func dataSourceApsaraStackCSManagerKubernetesClustersRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := invoker.Run(func() error {
		...
		return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_cs_managed_kubernetes_clusters", "DescribeClusters", DenverdinoApsaraStackgo)
	}
	if debugOn() {
	...
	for _, v := range filteredClusterTypes {
		...
		if err := invoker.Run(func() error {
			...
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_cs_managed_kubernetes_clusters", "DescribeKubernetesCluster", DenverdinoApsaraStackgo)
		}
		if debugOn() {
			requestMap := make(map[string]interface{})
	...
	for _, ct := range clusterTypes {
		...
		for {
			...
			if err := invoker.Run(func() error {
				...
				return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_cs_managed_kubernetes_clusters", "GetKubernetesClusterNodes", DenverdinoApsaraStackgo)
			}
			if debugOn() {
				requestMap := make(map[string]interface{})
		...
		if err := invoker.Run(func() error {
			...
			return WrapErrorf(err, DataDefaultErrorMsg, "apsarastack_cs_managed_kubernetes_clusters", "GetClusterEndpoints", DenverdinoApsaraStackgo)
		}
		...
		if err != nil {
			return WrapErrorf(err, DataDefaultErrorMsg, ct.VPCID, "DescribeNatGateways", ApsaraStackSdkGoERROR)
		}
